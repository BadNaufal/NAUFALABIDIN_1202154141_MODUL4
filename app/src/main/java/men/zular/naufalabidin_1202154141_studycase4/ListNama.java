package men.zular.naufalabidin_1202154141_studycase4;

/**
 * Created by Bdinz on 18/03/2018.
 */
...
public class ListNama extends AppCompatActivity {
    ...
    private String[] mahasiswaArray = {
            "Amon", "Azazel", "Baphomet", "Behemoth", "Demogorgon", "Lilith", "Sabazios", "Tezcatlipoca", "Metztli"
            , "Belioth", "Beelzebub", "Asmodeous", "Satanas", "Lucifer"};
